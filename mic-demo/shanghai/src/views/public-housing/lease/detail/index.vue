...
export default {
  ...
  created() {
    ...
    this.$ajax.all(this.getDetaiInfo()).then(() => {
      this.getRoomDetail();
  ...
  methods: {
    ...
    getRoomDetail() {
      ...
      return this.$ajax.get(
        this,
        this.$api.GET_HOUSE_ADDRESS_LIKE+'?id_in='+params,
        {},
        (res) => {
    ...
    getDetaiInfo() {
      ...
      return this.$ajax.get(
        ...
        (res) => {
          ...
          if(data.lease.roomSet && data.lease.roomSet.length>0){
            this.roomSet=data.lease.roomSet;
          }
    ...
    routeTo(type) {
      if(type == 'relet'){
        ...
        this.$router.push({
          name: 'public-housing/contract/tenant-register-'+type,
          query: {
            type: type,
            roomId: this.roomId,
            leaseId: this.leaseId,
