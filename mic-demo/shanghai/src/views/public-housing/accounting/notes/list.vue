        ...
        <div>
          ...
          <div class="summary">
            <Row >
              <Col span="12">
                 <Row>
                  <Col span="12">应收：{{titleData.realIncome}}元（{{titleData.realIncomeCount}}笔）</Col>
                  <Col span="12">应付：{{titleData.shouldOutcome}}元（{{titleData.shouldOutcomeCount}}笔）</Col>
                </Row>
                <Row>
                  <Col span="12">已收款（预收）：{{titleData.shouldIncome}}元（{{titleData.shouldIncomeCount}}笔）</Col>
                  <Col span="12">已付款（预付）：{{titleData.realOutcome}}元（{{titleData.realOutcomeCount}}笔）</Col>
                </Row>
              </Col>
              <Col span="12" class="right" >总计：{{titleData.shouldIncome}}元（{{titleData.shouldIncomeCount+titleData.shouldOutcomeCount+titleData.realIncomeCount+titleData.realOutcomeCount ?titleData.shouldIncomeCount+titleData.shouldOutcomeCount+titleData.realIncomeCount+titleData.realOutcomeCount :''}}笔）</Col>
            </Row>
          </div>
...
export default {
  ...
  methods: {
    ...
    ok () {
      if(this.isNew){
        //加houseKind
        // this.addData.houseKind=JSON.parse(this.$cookie.get('houseKind'))[0].key;
        ...
        // this.editData.houseKind=JSON.parse(this.$cookie.get('houseKind'))[0].key;
