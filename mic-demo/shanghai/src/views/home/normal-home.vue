      ...
      <Card dis-hover title="合同到期情况" icon="ios-list-box" style="height:190px;">
        <div class="info-container">
          ...
          <p style="text-align: right; line-height: 20px;">
            <a @click="routerTo('normal-housing/lease/lease-list', 'EXPIRE_SOON')">查看合同</a>
          </p>
        </div>
      </Card>
    </Col>
    <Col :span="8">
      <Card dis-hover title="逾期未缴情况" icon="ios-list-box" style="height:190px;">
        <div class="info-container">
          ...
          <Divider style="margin: 10px 0;" />
          <p style="text-align: right; line-height: 20px;">
            <a @click="routerTo('normal-housing/finance/account-list')">查看账单</a>
          </p>
        </div>
      </Card>
    </Col>
...
const option = {
  ...
  dataset: {
    // Provide data.
    source: [
      ['Income', '预存款入账', '预存款使用', '使用临时性减免', '本月应收', '实收入账', '往期欠款补收'],
      ['1月', 0, 0, 0, 0, 0, 0],
      ['2月', 0, 0, 0, 0, 0, 0],
      ['3月', 0, 0, 0, 0, 0, 0],
      ['4月', 0, 0, 0, 0, 0, 0],
  ...
  series: [
    { type: 'bar', barGap: 0, barWidth: '20%', itemStyle: {color: '#6ff4f1'}},
    { type: 'bar', barGap: 0, barWidth: '20%', stack: '实收', itemStyle: {color: '#4273fc'}},
    { type: 'bar', barGap: 0, barWidth: '20%', stack: '应收', itemStyle: {color: '#6c5bda'}},
    { type: 'bar', barGap: 0, barWidth: '20%', stack: '应收', itemStyle: {color: '#947fea'}},
    { type: 'bar', barGap: 0, barWidth: '20%', stack: '实收', itemStyle: {color: '#42a2fc'}},
    { type: 'bar', barGap: 0, barWidth: '20%', stack: '实收', itemStyle: {color: '#75d8ff'}},
  ]
};
export default {
  name: 'NormalHome',
    ...
    getIncome() { // 收入情况
      return this.$ajax.get(
        ...
        res => {
          ...
          const list = [], typeList = [2, 3, 5, 0, 1, 6];
          for(let key in obj) {
