<template>
  <Card dis-hover>
    <h1 style="text-align: center;margin: 20px 0;">租客续约</h1>
    ...
    <Card dis-hover>
      ...
      <Form  v-show="canUseElec" ref="contractForm" v-if="contractType == 0 && canUseElec" :model="formModel" label-position="right" :label-width="100" :rules="rules">
