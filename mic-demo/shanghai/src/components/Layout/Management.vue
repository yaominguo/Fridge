    ...
    <Layout class="ov-layout-mode-not-4">
      <Header class="ov-header">
        <Row>
          ...
          <Col v-if="mode !== 4" :span="headerLogoSpan">
            <slot name="logo"></slot>
          </Col>
          <Col :span="headerMenuSpan">
            <slot name="menu">&nbsp;</slot>
          </Col>
      ...
      <Layout class="ov-layout-mode-not-4">
        ...
        <Content :class="contentClass" ref="content">
...
export default {
  ...
  computed: {
    ...
    headerMenuSpan() {
      return 24 - this.headerLogoSpan - this.collapsedIconSpan - this.profileSpan;
    },
  },
  methods: {
    collapsedSider() {
